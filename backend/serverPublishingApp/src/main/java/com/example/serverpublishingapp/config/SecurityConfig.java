    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/reviews/**").hasRole("REVIEWER")
                        ...
                        .requestMatchers("/api/orders/editor/**").hasRole("EDITOR")
                        .requestMatchers("/api/orders/author/**").hasRole("AUTHOR")
                        .requestMatchers("/api/orders/*/comments").hasAnyRole("AUTHOR", "EDITOR", "REVIEWER", "ADMIN")
